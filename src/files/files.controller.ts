...
export class FilesController {
  ...
  adminCreate ( @Body() createFileDto: CreateFileDto, @I18n() i18n: I18nContext, @Metadata() metadata: IMetadataDecorator ) {
  ...
  adminFindAll ( @Query() query: FilesListQueryDto ) {
  ...
  @UseGuards( JwtAuthGuard, PermissionsGuard )
  @RequirePermission( PermissionsEnum.ADMIN, PermissionsEnum.FILE_READ )
  adminFindOneById ( @Param( 'id' ) id: string, @I18n() i18n: I18nContext ) {
  ...
  adminUpdate ( @Param( 'id' ) id: string, @Body() updateFileDto: UpdateFileDto, @I18n() i18n: I18nContext ) {
  ...
  @UseGuards( JwtAuthGuard, PermissionsGuard )
  @RequirePermission( PermissionsEnum.ADMIN, PermissionsEnum.FILE_DELETE )
  adminBulkSoftRemove ( @Body() bulkDeleteRecoverDto: BulkDeleteRecoverDto, @I18n() i18n: I18nContext ) {
  ...
  @UseGuards( JwtAuthGuard, PermissionsGuard )
  @RequirePermission( PermissionsEnum.ADMIN, PermissionsEnum.FILE_DELETE )
  adminBulkRecover ( @Body() bulkDeleteRecoverDto: BulkDeleteRecoverDto, @I18n() i18n: I18nContext ) {
  ...
  @UseGuards( JwtAuthGuard, PermissionsGuard )
  @RequirePermission( PermissionsEnum.ADMIN, PermissionsEnum.FILE_DELETE )
  adminBulkRemove ( @Body() bulkDeleteRecoverDto: BulkDeleteRecoverDto, @I18n() i18n: I18nContext ) {
